      ...
      <div class="container-fluid">
        ...
        <div>
          <ul class="nav navbar-nav">
            ...
            <div class="container-fluid">
                <div class="card">
                <p><span style="font-size: 1.5em">Obesity or Overweight</span></p><hr>
                <p>Primary care health professionals are encouraged to create a nonjudgmental atmosphere when discussing weight management.</p>

    <p>Maintenance of a healthy body weight (body mass index 18.5 to 24.9 kg/m2, and waist circumference less than 102 cm for men and less than 88 cm for women Caucasian only/measurements vary with ethnicity) is recommended for non-hypertensive individuals to prevent hypertension and for hypertensive patients to reduce blood pressure. All overweight hypertensive individuals should be advised to lose weight.</p>

    <p>All individuals should be encouraged to adopt healthy eating habits to lower their CVD risk: (1) moderate energy (caloric) intake to achieve and maintain a healthy body weight; (2) emphasize a diet rich in vegetables, fruit, whole-grain cereals, and polyunsaturated and monounsaturated oils, including omega-3 fatty acids particularly from fish; (3) avoid trans fats, limit saturated and total fats to < 7% and <30% of daily total energy (caloric) intake, respectively; (4) increase daily fibre intake to >30 g; (5) limit cholesterol intake to 200 mg daily for individuals with dyslipidemia or at increased CVD risk. [4;5]</p>

    <p>A comprehensive healthy lifestyle intervention is recommended for overweight and obese people.</p>
        <ul><li>An optimal dietary plan for achieving healthy body weight and dietary counseling for adults should be developed with a qualified and experienced health professional (preferably a registered dietitian) together with the individual and family to meet their needs.</li>
        <li>Screening for eating disorders, depression and psychiatric disorders, as appropriate.</li>
        <li>All those considering initiating a vigorous exercise program are encouraged to consult their physician or health care team professionals</li>
        <li>Adults with class III overweight/obesity (BMI ≥ 40.0 kg/m2) or class II overweight/obesity (BMI 35.0 to 39.9 kg/m2) with other comorbidities may be considered for bariatric surgery when other lifestyle interventions are inadequate in achieving weight goals.</li>
            </div><br><br><br>
            </div>
