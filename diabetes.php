      ...
      <div class="container-fluid">
        ...
        <div>
          <ul class="nav navbar-nav">
            ...
            <div class="container-fluid">
                <div class="card">
                <p><span style="font-size: 1.5em">Diabetes</span></p><hr>
                <p>When screening for diabetes using FPG and/or A1C should be performed every 3 years in individuals > or = 40 years of age.</p>
                <p>Please note: When calculating the Framingham Risk Score for people that have diabetes consider the following:</p>
                <ol style="list-style-type:lower-roman">
                    <li>men > 45 years and women >50 years.</li>
                    <li>If men < 45 years and women < 50 years but have one of the following macrovascular disease (CVD, cerebrovascular disease, PAD), microvascular disease (retinopathy, neuropathy and nephropathy),</li>
                    <li>family history of a first-degree relative, </li>
                    <li>markedly elevated single risk factor (eg. BP >180 or LDL>5 mmol/L).</li>
                </ol>
                ...
                <p>Pharmacotherapy:</p>
                <ul>
                    <li>Anti-hyperglycemic agents see http://guidelines.diabetes.ca/bloodglucoselowering/pharmacology</li>
                    <li>Anti-hypertensive agents: Beta-blockers (when indicated for systolic heart failure not as monotherapy for people >60 years of age),</li>
                    <li>ACE-inhibitors or ARBs (clinical macrovascular disease, >55 years, < 55 years and microvascular disease) are preferred agents for people with diabetes </li>
                    <li>Statins are also recommended for people with type 1 or type 2 Diabetes and with evidence of</li>
                    <li>Macrovascular disease, </li>
                    <li>40 years of age</li>
                    <li>30 years of age with DM for 15 years</li>
                    <li>Microvascular disease</li>
                </ul>
                ASA is no longer solely recommended for people with diabetes unless it is indicated for other reasons.
                For more information visit http://guidelines.hypertension.ca/prevention-treatment/uncomplicated-hypertension-therapy/
                People with diabetes should be offered timely diabetes education that is tailored to enhance self-care practices and behaviours.
            </div><br><br><br>
            </div>
