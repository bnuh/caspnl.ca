  ...
  <body>
    <nav class="navbar navbar-default" style="border-radius: 0">
      <div class="container-fluid">
        ...
        <div class="container-fluid">
            <div class="card">
            <p><span style="font-size: 1.5em">Dyslipidemia</span></p><hr>
            <p>Please note: Screening at any age if smoking, diabetes, hypertension, overweight, rheumatoid arthritis, lupus, psoriatic arthritis ankylosing spondylitis, IBD, COPD, HIV, CKD, AAA or ED, South Asian, or First Nations)</p>
<p>*Non-fasting lipid and lipoprotein testing can be performed in adults in whom screening is indicated as part of a comprehensive risk assessment to reduce CVD events (Strong Recommendation; High-Quality Evidence).</p>
<p></p>Practical tip: Compared with fasting lipid values, there will be minimal change with non-HDL-C, a slight decrease in LDL-C, and small increase in triglyceride concentrations when individuals do not fast. For individuals with a history of triglyceride levels > 4.5 mmol/L the lipid and lipoprotein levels should be measured fasting.</p<
<p>In Intermediate risk individuals with LDL-C > 3.5 mmol/L, apo B > 1.2 g/L, or non-HDL-C > 4.3 mmol/L is suggested to identify patients who might benefit from pharmacotherapy. We recommend a target LDL-C < 2.0 mmol/L or > 50% reduction of LDL-C for intermediate risk individuals in whom treatment is initiated. Alternative target variables are apo B < 0.8 g/L or non-HDL-C < 2.6 mmol/L</p>
<p>Pharmacotherapy recommendations A wider range of patients are now eligible for statin therapy in the FRS intermediate risk category (10%-19%) and in those with a high FRS (> 20%).</p>
<p>Statins remain the treatment of choice. Drugs and dosages need to be tailored to individual choice and tolerance of side effects to improve adherence to drug therapy and the likelihood that target lipid levels will be reached.</p>
<p><a href="2016Dyslipidemia.pdf">Click here</a> for a PDF of the 2016 Dyslipidemia Guidelines</p>
        </div><br><br><br>
        </div>
