...
<body>
  ...
  <div class="jumbotron" style="background-image: url('jumbotron.jpg'); color:#fff">
    <div class="container">
      <h1 class="display-3"><center>Welcome to CASP!</center></h1>
      <p><center>A program created to prioritize health screening and improve access to primary health care services in Newfoundland & Labrador</p></center>
      <p><center><a class="btn btn-primary btn-lg" href="research.php" role="button">Learn more &raquo;</a></p></center>
    </div>
  </div>
  <div class="container">
      <div class="row">
            <div class="col-md-4">
                <a href="tree.php">
                    <div id="card1" class="card">
                        <div class="card-body">
                        <h2>Decision Tree</h2>
                        <p>An interactive assessment tool to help identify high risk people and recommend management of risk factors according to current guidelines.</p>
                        <p><a class="btn btn-secondary" href="tree.php" role="button">View details &raquo;</a></p>
                        </div>
                    </div>
                </a>
            </div>
        <div class="col-md-4">
            ...
            <div id="card2" class="card">
              ...
              <p>Primary halth care services for the Eastern, Western, Central and Labrador-Grenfell Health care regions of Newfoundland and Labrador.</p>
              <p><a class="btn btn-secondary" href="providers.php" role="button">View details &raquo;</a></p>
              </div>
            </div>
            </a>
        </div>
        <div class="col-md-4">
            ...
            <div id="card3" class="card">
              ...
              <p>Clinical health guidelines to assist facilitate health management and control by providers and self-management by patients.</p>
              <p><a class="btn btn-secondary" href="links.php" role="button">View details &raquo;</a></p>
              </div>
            </div>
            </a>
        </div>
